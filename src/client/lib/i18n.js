...
const translations = {
  zh: {
    ...
    'chat.suggestion1': '帮我创建一个 React 项目，请使用 write_file 格式创建所有必需文件（package.json、vite.config.js、src/main.jsx、src/App.jsx、src/index.css、index.html）',
  ...
  en: {
    ...
    'chat.suggestion1': 'Help me create a React project, please use write_file format to create all necessary files (package.json, vite.config.js, src/main.jsx, src/App.jsx, src/index.css, index.html)',
